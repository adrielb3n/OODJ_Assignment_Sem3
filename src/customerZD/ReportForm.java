...
public class ReportForm extends javax.swing.JFrame {
    ...
    private String id;
    JFrame frame;
    public ReportForm(String id, JFrame frame) {
        initComponents();
        this.id=id;
        this.frame=frame;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     //validate no multiline entries (HG Lim)   
     if (jTextArea1.getText().contains("\n"))
     {
         JOptionPane.showMessageDialog(null, "Please do not enter multilines comments.");
     }
     else
     {
        report.addReport(id, jTextArea1.getText());
