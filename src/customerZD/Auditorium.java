...
public class Auditorium extends javax.swing.JFrame {
    ...
    ArrayList<ArrayList<String>> audi;
    String userID;
    ...
    public Auditorium(String userID) {
        initComponents();
        this.userID = userID;
    ...
    private void initComponents() {
        ...
        btnAuditorium.setForeground(new java.awt.Color(87, 114, 255));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnAuditorium, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Auditorium().setVisible(true);
            }
        });
    }
